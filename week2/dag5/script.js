...
text += "<li>" + movies[i].Title + " : " + "</br>" +  "<a href= https://www.imdb.com/title/" 
+ movies[i].imdbID + " target=_blank><img src="
 + movies[i].Poster + "></a>"  + "</li>";
}
text += "</ul>";
...
text += "<li>" + filmName[i].Title + " : " + "</br>" +  "<a href= https://www.imdb.com/title/" 
+ filmName[i].imdbID + " target=_blank><img src="
 + filmName[i].Poster + "></a>"  + "</li>";
}
text += "</ul>";
 document.getElementById("showFilms").innerHTML = text;
}
